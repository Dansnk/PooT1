...
public class Spring extends PhysicsElement {
   ...
   /**
    * Metodo que verifica si no existen otras bolas unidas en las posiciones A o B y las une al Spring.
    * Se une un Spring a una bola, no al reves.
    * @param sa Bola que se desea unir al Spring
    */
   ...
   /**
    * Metodo que entrega el estado actual de la posicion A y B.
    * @return String con la posicion A y B actual
    */
